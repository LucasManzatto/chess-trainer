...
The free-play page (chess board + move list, currently in `App.tsx`) SHALL be the index route at `/`, defined in `src/routes/index.tsx`. All existing free-play functionality SHALL be preserved unchanged.
