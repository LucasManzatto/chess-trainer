...
The top nav SHALL contain links to: Free Play (`/`), Puzzles (`/puzzles`), Openings (`/openings`), Dashboard (`/dashboard`), Games (`/games`). Active link SHALL be visually distinguished from inactive links.
