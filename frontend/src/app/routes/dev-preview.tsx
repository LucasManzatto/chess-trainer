...
const MOCK_GAMES: Game[] = [
  {
    ...
    reviewed: false, critical_moves: null, left_repertoire_ply: null,
  },
  {
...
function DevPreview() {
  ...
  const [filters, setFilters] = useState<GamesFilters>({ result: null, color: null, has_critical_moves: null, reviewed: null, first_critical_move: null, left_repertoire: null })
