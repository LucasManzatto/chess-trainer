    ...
    <div className="flex items-center gap-2">
      {annotationsDirty && (
        <button
          ...
          className="bg-white/[0.06] hover:bg-white/[0.1] border border-white/15 text-white/80 text-xs font-medium rounded px-3 py-1.5 transition-colors cursor-pointer"
        >
          Save annotations
        </button>
      )}
